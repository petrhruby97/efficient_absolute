...
)
{
	...
	sample_line(R,T,d2,d3,L1,L2,Y0,D1,D2);
	sample_line(R,T,d4,d5,L3,L4,Y0,D1,D2);
...
{	
	...
	for(int i=0;i<num_iters;++i)
	{
		...
		/*std::cout << "GT:\n";
		std::cout << (d1).cross(Rgt*P1+tgt) << "\n";
		std::cout << (d2.cross(d3)).dot(Rgt*L1+tgt) << "\n";
		std::cout << (d2.cross(d3)).dot(Rgt*L2+tgt) << "\n";
		std::cout << (d4.cross(d5)).dot(Rgt*L3+tgt) << "\n";
		std::cout << (d4.cross(d5)).dot(Rgt*L4+tgt) << "\n";
		std::cout << "\n\n";*/
		...
		for(int j=0;j<num_sols_3q3 ;++j)
		{
			...
			/*std::cout << "3Q3:\n";
			std::cout << (d1).cross(sols_3q3[j].R()*P1+tgt) << "\n";
			std::cout << (d2.cross(d3)).dot(sols_3q3[j].R()*L1 + sols_3q3[j].t) << "\n";
			std::cout << (d2.cross(d3)).dot(sols_3q3[j].R()*L2 + sols_3q3[j].t) << "\n";
			std::cout << (d4.cross(d5)).dot(sols_3q3[j].R()*L3 + sols_3q3[j].t) << "\n";
			std::cout << (d4.cross(d5)).dot(sols_3q3[j].R()*L4 + sols_3q3[j].t) << "\n";
			std::cout << "\n\n";*/
